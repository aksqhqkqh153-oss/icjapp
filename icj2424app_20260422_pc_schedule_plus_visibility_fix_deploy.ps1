...
$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_pc_schedule_plus_visibility_fix.zip"
$Project = "C:\Users\icj24\Downloads\icjapp"
$Branch = "main"
$CommitMessage = "update: fix desktop schedule plus visibility on current month"
