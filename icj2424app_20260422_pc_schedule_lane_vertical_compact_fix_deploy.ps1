...
$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_pc_schedule_lane_vertical_compact_fix.zip"
$Project = "C:\Users\icj24\Downloads\icjapp"
$Branch = "main"
$CommitMessage = "update: tighten desktop schedule lane vertical spacing"
