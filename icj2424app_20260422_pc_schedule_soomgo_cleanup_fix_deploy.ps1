...
$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_pc_schedule_soomgo_cleanup_fix.zip"
$Project = "C:\Users\icj24\Downloads\icjapp"
$Branch = "main"
$CommitMessage = "update: tighten desktop schedule lanes and clean soomgo review text"
