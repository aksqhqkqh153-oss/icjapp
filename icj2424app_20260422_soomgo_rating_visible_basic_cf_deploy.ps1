param(
    [string]$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_soomgo_rating_layout_fix.zip",
    [string]$Project = "C:\Users\icj24\Downloads\icjapp",
    [string]$Branch = "main",
    [string]$CommitMessage = "update: fix soomgo rating slot visibility and review layout",
