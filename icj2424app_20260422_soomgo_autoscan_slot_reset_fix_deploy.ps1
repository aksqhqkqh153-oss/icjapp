...
$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_soomgo_autoscan_slot_reset_fix.zip"
$Project = "C:\Users\icj24\Downloads\icjapp"
$Branch = "main"
$CommitMessage = "update: reset soomgo slots before applying auto scan results"
