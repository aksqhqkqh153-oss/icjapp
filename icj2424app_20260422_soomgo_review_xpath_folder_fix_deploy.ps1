...
$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_soomgo_review_xpath_folder_fix.zip"
$Project = "C:\Users\icj24\Downloads\icjapp"
$Branch = "main"
$CommitMessage = "update: fix soomgo review xpath scan and folder path setting"
