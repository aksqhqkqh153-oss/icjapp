...
$Zip = "C:\Users\icj24\Downloads\icj2424app_20260422_soomgo_open_clear_then_autoscan_fix.zip"
$Project = "C:\Users\icj24\Downloads\icjapp"
$Branch = "main"
$CommitMessage = "update: clear soomgo slots on page open before auto scan"
